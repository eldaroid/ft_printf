...
/*   Updated: 2020/08/14 17:04:12 by fgracefo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int						print_type(const char *str,
						size_t *i, va_list list, t_flag flag);
int						ft_count_size(const char *format,
						size_t *i, va_list list);
t_flag					ft_parse_zero(const char *format, size_t *i,
						va_list list, t_flag flag);
t_flag					ft_parse_flag(const char *format, size_t *i,
						va_list list, t_flag flag);
...
t_flag					ft_parse_plus(const char *format, size_t *i,
						va_list list, t_flag flag);
t_flag					ft_parse_dot(const char *format, size_t *i,
						va_list list, t_flag flag);
t_flag					ft_parse_space(const char *format, size_t *i,
						va_list list, t_flag flag);
t_flag					ft_parse_minus(const char *format, size_t *i,
						va_list list, t_flag flag);
...
char					*ft_itoa_addres(unsigned long long n, t_flag flag);
char					*ft_itoa(int n);
int						division_by_type(int type, va_list list,
						t_flag flag, int count);
...
int						check_flag_size(t_flag flag,
						long long int i, int str_len);
int						check_strlen(t_flag flag,
						char *str, int str_len, long long int i);
int						ft_check_power(t_flag flag,
						unsigned long long int n, int base);
int						check_power(t_flag flag,
						long long n, int base, int sign);
int						new_star(t_flag flag, int len);
char					*new_string(t_flag flag, int base, va_list list);
int						check_undefine(t_flag flag);
char					*ft_bef(long double number, int check_dot,
						t_flag flag, int zero);
